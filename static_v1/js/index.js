...
let headshots = `[
    {
        "image": "images/photo_headshot_business.jpg"
    },
    {
        "image": "images/photo_headshot_climb.jpg"
    },
    {
        "image": "images/photo_headshot_knit.jpg"
    }
]`;
...
$(function () {
    ...
    $('.headshot').attr('src', headshot).addClass('headshot-test');
    ...
    // event listener for swapping headshot
